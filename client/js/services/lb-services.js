      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/notes/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Note.user() instead.
            "prototype$__get__user": {
              url: urlBase + "/notes/:id/user",
              method: "GET",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.Note#prototype$archive
             * @methodOf lbServices.Note
             *
             * @description
             *
             ...
             */
            "prototype$archive": {
              url: urlBase + "/notes/:id/archive",
              method: "POST",
            },

            // INTERNAL. Use User.notes.findById() instead.
            "::findById::User::notes": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/users/:id/notes/:fk",
              method: "GET",
            },

            // INTERNAL. Use User.notes.destroyById() instead.
            "::destroyById::User::notes": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/users/:id/notes/:fk",
            ...
            // INTERNAL. Use User.notes.updateById() instead.
            "::updateById::User::notes": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/users/:id/notes/:fk",
            ...
            // INTERNAL. Use User.notes() instead.
            "::get::User::notes": {
              isArray: true,
              url: urlBase + "/users/:id/notes",
              method: "GET",
            },

            // INTERNAL. Use User.notes.create() instead.
            "::create::User::notes": {
              url: urlBase + "/users/:id/notes",
              method: "POST",
            },

            // INTERNAL. Use User.notes.createMany() instead.
            "::createMany::User::notes": {
              isArray: true,
              url: urlBase + "/users/:id/notes",
              method: "POST",
            },

            // INTERNAL. Use User.notes.destroyAll() instead.
            "::delete::User::notes": {
              url: urlBase + "/users/:id/notes",
              method: "DELETE",
            },

            // INTERNAL. Use User.notes.count() instead.
            "::count::User::notes": {
              url: urlBase + "/users/:id/notes/count",
              method: "GET",
            },
          }
        );
        ...
        */
        ...
        R.user = function() {
          ...
          var action = TargetResource["::get::Note::user"];
 ...
 */
  module.factory(
    ...
    /**
     * @ngdoc object
     * @name lbServices.User.notes
     * @header lbServices.User.notes
     * @object
     * @description
     *
     * The object `User.notes` groups methods
     * manipulating `Note` instances related to `User`.
     *
     * Call {@link lbServices.User#notes User.notes()}
     ...
     */
        ...
        R.notes = function() {
          ...
          var action = TargetResource["::get::User::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.User.notes#count
             * @methodOf lbServices.User.notes
             *
             * @description
             *
             * Counts notes of user.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - user id
        ...
        R.notes.count = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::count::User::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.User.notes#create
             * @methodOf lbServices.User.notes
             *
             * @description
             *
        ...
        R.notes.create = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::create::User::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.User.notes#createMany
             * @methodOf lbServices.User.notes
             *
             * @description
             *
        ...
        R.notes.createMany = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::createMany::User::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.User.notes#destroyAll
             * @methodOf lbServices.User.notes
             *
             * @description
             *
        ...
        R.notes.destroyAll = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::delete::User::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.User.notes#destroyById
             * @methodOf lbServices.User.notes
             *
             * @description
             *
        ...
        R.notes.destroyById = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::destroyById::User::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.User.notes#findById
             * @methodOf lbServices.User.notes
             *
             * @description
             *
        ...
        R.notes.findById = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::findById::User::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.User.notes#updateById
             * @methodOf lbServices.User.notes
             *
             * @description
             *
        ...
        R.notes.updateById = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::updateById::User::notes"];
          return action.apply(R, arguments);
        };
